...
import uk.co.hexeption.thx.event.events.EventPostMotionUpdates;
import uk.co.hexeption.thx.event.events.EventPreMotionUpdates;
    ...
    public void onUpdate() {
        ...
        if (this.world.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
            ...
            if (this.isRiding()) {
                ...
                //TODO: Client
                EventPreMotionUpdates eventPreMotionUpdates = new EventPreMotionUpdates(this.rotationYaw, this.rotationPitch, this.posY);
