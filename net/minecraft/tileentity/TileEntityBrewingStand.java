...
public class TileEntityBrewingStand extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    public boolean isItemValidForSlot(int index, ItemStack stack)
    {
        ...
        else
        {
            ...
            return index == 4 ? item == Items.BLAZE_POWDER : (item == Items.POTIONITEM || item == Items.SPLASH_POTION || item == Items.LINGERING_POTION || item == Items.GLASS_BOTTLE) && this.getStackInSlot(index) == ItemStack.EMPTY;
        }
    }
